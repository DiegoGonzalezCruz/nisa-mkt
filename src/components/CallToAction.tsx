...
export const CallToAction = () => {
  ...
  return <section id="cta" className="w-full bg-white py-section-mobile md:py-section-desktop relative overflow-hidden">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-6xl mx-auto">
          <div className="grid lg:grid-cols-12 gap-8 lg:gap-20 items-center">
            <div className="lg:col-span-12"></div>
            <div className="lg:col-span-12">
              <img src="/image.png" alt="Decorative divider with plant illustrations" className="w-full mx-auto mb-8" />
                  ...
                  {isSubmitted ? <div className="text-center py-8">
                      ...
                      <div className="flex justify-center">
                        <div className="transform scale-110">
                          <Button type="button" size="lg" onClick={openJoinPilotModal}>
                            Join the Nisa pilot
