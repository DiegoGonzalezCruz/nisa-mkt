                          ...
                          <div className="space-y-2 mt-2">
                            ...
                            <div className="flex items-start">
                              <input
                                ...
                                checked={
                                  formData.coachingCapacity.districtCoach
                                }
                                onChange={handleInputChange}
                                className="mt-1 mr-2"
                              />
                              <label
                                htmlFor="districtCoach"
                                className="text-sm text-gray-700"
                              >
                                District Coach
                              </label>
                            ...
                            <div className="flex items-start">
                              <input
                                ...
                                checked={
                                  formData.coachingCapacity
                                    .coachingProviderEmployee
                                }
                                onChange={handleInputChange}
                                className="mt-1 mr-2"
                              />
                            ...
                            <div className="flex items-start">
                              <input
                                ...
                                checked={
                                  formData.coachingCapacity.administrator
                                }
                                onChange={handleInputChange}
                                className="mt-1 mr-2"
                              />
                          ...
                          <div className="space-y-2 mt-2">
                            <div className="flex items-start">
                              <input
                                ...
                                checked={
                                  formData.teachingLabRelationship
                                    .fullTimeEmployee
                                }
                                onChange={handleInputChange}
                                className="mt-1 mr-2"
                            ...
                            <div className="flex items-start">
                              <input
                                ...
                                checked={
                                  formData.teachingLabRelationship.tabMember
                                }
                                onChange={handleInputChange}
                                className="mt-1 mr-2"
                              />
                            ...
                            <div className="flex items-start">
                              <input
                                ...
                                checked={
                                  formData.teachingLabRelationship.notAffiliated
                                }
                                onChange={handleInputChange}
                                className="mt-1 mr-2"
                              />
                              <label
                                htmlFor="notAffiliated"
                                className="text-sm text-gray-700"
                              >
